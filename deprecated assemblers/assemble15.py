...
def parse_arguments():
    ...
    parser.add_argument('--middle', dest='middle', help='middle fragments file', type=str, default='middle_infer')
...
def assembler(fraglist,fragnum, overlap, midlist):
