...
tar='inference_data1000by20_04_assemble4' #name of output dir
car='test1000_04_infer' #name of inference file
fragnum=50

echo $foo; 

python ./assemble4.py --outdir=$foo/$tar --f_inference="$foo/$car" --fragnum=$fragnum --mode="both" --bias=sin
...
python ./assemble4.py --outdir=$foo/$tar --f_inference="$foo/$car" --fragnum=$fragnum --mode="both" --bias=log
echo "edit log"
...
python ./assemble4.py --outdir=$foo/$tar --f_inference="$foo/$car" --fragnum=$fragnum --mode="both" --bias=logsin
echo "edit logsin"
