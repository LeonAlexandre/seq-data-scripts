...
tar='inference_data1000by20_04_assemble7' #name of output dir
car='test1000_04_infer' #name of inference file
fragnum=50

echo $foo; 

python ./assemble7.py --outdir=$foo/$tar --f_inference="$foo/$car" --fragnum=$fragnum --mode="both" --bias=sin
...
python ./assemble7.py --outdir=$foo/$tar --f_inference="$foo/$car" --fragnum=$fragnum --mode="both" --bias=log
echo "edit log"
...
python ./assemble7.py --outdir=$foo/$tar --f_inference="$foo/$car" --fragnum=$fragnum --mode="both" --bias=logsin
echo "edit logsin"
