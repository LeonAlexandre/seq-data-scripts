...
tar='inference_data100by20_04_assemble10' #name of output dir
...
python ./assemble10.py --outdir=$foo/$tar --f_inference="$foo/$car" --fragnum=$fragnum --mode="both" --bias=logsin
echo "edit logsin"
